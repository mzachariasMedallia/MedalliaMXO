...
SDK_DIR="$HOME/Development/private/DynamicLibrary/MedalliaMXO"
MODE=Release
...
ARCHIVE_DIR="$SDK_DIR/Archives/$MODE/MedalliaMXO"
ARCHIVE_DIR_SIMULATOR="$SDK_DIR/Archives/$MODE/MedalliaMXO-Simulator"
XCFRAMEWORK_DIR="$SDK_DIR/MedalliaMXO.xcframework"
...
xcodebuild -create-xcframework \
    -framework "$ARCHIVE_DIR.xcarchive/Products/Library/Frameworks/MedalliaMXO.framework" \
    -framework "$ARCHIVE_DIR_SIMULATOR.xcarchive/Products/Library/Frameworks/MedalliaMXO.framework" \
